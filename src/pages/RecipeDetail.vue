<template>
  <div
    class="bg-white dark:bg-neutral-900 min-h-screen transition-colors duration-300"
  >
    <Header />
    ...
    >
      ...
      <div class="lg:col-span-7 lg:pl-12">
        ...
        <div>
          <h2
            class="text-2xl font-bold mt-6 mb-3 text-gray-900 dark:text-white"
          >
            Ingredienser
          </h2>
          ...
          <h2
            class="text-2xl font-bold mt-8 mb-3 text-gray-900 dark:text-white"
          >
            Gör så här
          </h2>
    ...
    <div v-else class="text-center py-32">
      ...
      <p class="text-gray-600 dark:text-neutral-400 mt-2">
        ...
        <router-link
          to="/recept"
          class="text-green-700 dark:text-green-400 underline hover:text-green-800 dark:hover:text-green-300"
        >
